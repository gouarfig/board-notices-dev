...
class main_module
{
	...
	public function main($id, $mode)
	{
		...
		/** @var \test\test\controller\acp_controller $acp_controller */
		$acp_controller = $phpbb_container->get('test.test.controller.acp');
		...
		$this->page_title = $language->lang('ACP_TEST_TITLE');
