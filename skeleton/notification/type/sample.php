...
class sample extends \phpbb\notification\type\base
{
	...
	{
		return 'test.test.notification.type.sample';
	}
	...
	{
		return $this->language->lang('TEST_TEST_NOTIFICATION');
	}
	...
	{
		return $this->helper->route('test_test_controller', $this->get_data('test_sample_name'));
	}
	...
	{
		$this->set_data('test_sample_name', $data['test_sample_name']);
