...
class ext extends \phpbb\extension\base
{
	...
	public function enable_step($old_state)
	{
		if ($old_state === false)
		{
			$this->container->get('notification_manager')
				->enable_notifications('test.test.notification.type.sample');
	...
	public function disable_step($old_state)
	{
		...
		{
			$this->container->get('notification_manager')
				->disable_notifications('test.test.notification.type.sample');
	...
	public function purge_step($old_state)
	{
		...
		{
			$this->container->get('notification_manager')
				->purge_notifications('test.test.notification.type.sample');
